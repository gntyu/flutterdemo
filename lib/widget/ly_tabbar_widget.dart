...
class LYTabBarWidget extends StatefulWidget {
  ///底部模式type
  ...
  @override
  _LYTabBarState createState() => new _LYTabBarState(
        type,
        tabViews,
        indicatorColor,
        title,
...
class _LYTabBarState extends State<LYTabBarWidget>
  ...
  Widget build(BuildContext context) {
    if (this._type == LYTabBarWidget.TOP_TAB) {
      ///顶部tab bar
      return new Scaffold(
